                ...
                <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden z-[9999] animate-in fade-in slide-in-from-top-2 duration-200 w-[220px]">
                            ...
                            <div className="mt-0.5">
                                {workspaces.filter(ws => ws.isPrivate).map((ws) => (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-2.5 px-3 py-2 text-sm transition-colors ${currentWorkspace._id === ws._id
                                            ? 'bg-orange-50 text-orange-600'
                                            : 'text-gray-700 hover:bg-gray-50'
                                            }`}
                                    >
                                        <div className={`w-6 h-6 rounded flex items-center justify-center text-xs font-semibold ${currentWorkspace._id === ws._id
                                        ...
                                        {currentWorkspace._id === ws._id && (
                                            <Check size={14} className="text-orange-600" strokeWidth={2.5} />
                                        )}
                                    </button>
                                ))}
                            </div>
                    ...
                    <div className="border-t border-gray-100 py-2 px-2">
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-2 py-2 text-sm text-gray-600 hover:text-primary hover:bg-gray-50 rounded-lg transition-colors"
                        >
                        ...
                        <button
                            ...
                            className="w-full flex items-center gap-2 px-2 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                        >
